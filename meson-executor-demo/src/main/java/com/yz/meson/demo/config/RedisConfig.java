package com.yz.meson.demo.config;
...
//    @Bean
//    public RedissonClient redissonClient(RedissonProperties redissonProperties) throws Exception{
...
//            throw new IllegalAccessException("redisson.sentinel.sentinel-addresses is null");
//        }
