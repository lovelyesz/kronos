 ...
 **/
@Component
public class RedisJobQueueManage implements JobQueueManage {
    ...
    public void add(String key, ExecuteJobInfo executeJobInfo) {
        ...
        queue.expire(ExecuteConstant.KRONOS_EXECUTOR_EXPIRE_TIME,ExecuteConstant.KRONOS_EXECUTOR_EXPIRE_TIME_UNIT);
    }
